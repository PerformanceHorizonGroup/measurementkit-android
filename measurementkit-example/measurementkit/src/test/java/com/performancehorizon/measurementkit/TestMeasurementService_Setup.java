...
public class TestMeasurementService_Setup {
    ...
    @Mock private RegisterRequestQueue registerQueue;
    @Mock private EventRequestQueue eventQueue;
    @Mock private FingerprinterFactory fingerprinterFactory;
    @Mock private MeasurementServiceConfiguration config;

    //mocks for initialisation
    @Mock private Context context;
    @Mock private MeasurementService.MeasurementStorageFactory storageFactory;
    @Mock private MeasurementService.ReachabilityFactory reachabilityFactory;
    @Mock private MeasurementService.IntentProcessorFactory processorFactory;
    @Mock private MeasurementService.RegisterRequestFactory registerRequestFactory;

    @Mock private MeasurementServiceStorage storage;
    @Mock private Reachability reachability;
    @Mock private RegisterRequest registerRequest;
    @Mock private Fingerprinter fingerprinter;

    @Mock private WebClickIntentProccessor webProcessor;
    @Mock private UniversalIntentProcessor universalProcessor;
    @Mock private AppClickIntentProcessor appProcessor;

    @Mock private ReachabilityCallback reachabilitycallback;
